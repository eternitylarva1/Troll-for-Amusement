...
import static Zhenghuo.modcore.CustomTags.WordCard;

public class WuwenPower extends AbstractPower {
    // 能力的ID
    ...
    public WuwenPower(AbstractCreature owner, int Amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
