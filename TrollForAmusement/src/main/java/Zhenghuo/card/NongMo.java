...
import Zhenghuo.powers.NongmoPower;
...
public class NongMo extends CustomCard {

    public static final String ID = ModHelper.makePath("NongMo");
...
// Step 3: 设置卡牌的portrait属
    ...
    this.addToBot(new ApplyPowerAction(p,p,new NongmoPower(p,this.magicNumber)));
    }
