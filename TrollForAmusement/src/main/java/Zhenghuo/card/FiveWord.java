...
import Zhenghuo.powers.FiveWordPower;
...
public class FiveWord extends CustomCard {

    public static final String ID = ModHelper.makePath("FiveWord");
...
// Step 3: 设置卡牌的portrait属
    ...
    this.addToBot(new ApplyPowerAction(p,p,new FiveWordPower(p,this.magicNumber)));
    }
