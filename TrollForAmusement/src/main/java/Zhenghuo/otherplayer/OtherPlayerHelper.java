...
import Zhenghuo.patchs.PlayerAddFieldsPatch;
...
public class OtherPlayerHelper {
    public OtherPlayerHelper() {
    }
    ...
    {
        int i=0;
        for (AbstractMonster m:OtherPlayerHelper.getMinions().monsters)
        {
